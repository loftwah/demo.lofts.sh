...
import styles from "assets/jss/nextjs-dashboard-lofts-sh/customCheckboxRadioSwitch.js";
        ...
        <ul className="dropdown-menu">
          ...
          <li className="button-container">
            <div>
              <Button
                color="warning"
                href="https://lofts.sh/product/nextjs-dashboard-lofts-sh?ref=njsmdp-fixed-plugin"
                target="_blank"
                fullWidth
              >
                Buy now
          ...
          <li className="button-container">
            <div>
              <Button
                color="info"
                href="https://lofts.sh/learning-lab/nextjs/overview/material-dashboard?ref=njsmdp-fixed-plugin"
                target="_blank"
                fullWidth
              >
                Documentation
