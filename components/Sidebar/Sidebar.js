...
import sidebarStyle from "assets/jss/nextjs-dashboard-lofts-sh/components/sidebarStyle.js";
  ...
  render() {
      ...
      <div className={userWrapperClass}>
        ...
        <List className={classes.list}>
          <ListItem className={classes.item + " " + classes.userItem}>
            ...
            >
              <ListItemText
                primary={rtlActive ? "تانيا أندرو" : "Dean Lofts"}
                secondary={
                  <b
                    className={
                      caret +
    ...
    var brand = (
      <div className={logoClasses}>
        <a
          href="https://lofts.sh?ref=njsmdp-sidebar"
          target="_blank"
          className={logoMini}
        >
