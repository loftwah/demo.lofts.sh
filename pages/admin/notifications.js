...
import styles from "assets/jss/nextjs-dashboard-lofts-sh/views/notificationsStyle.js";
      ...
      <Heading
        ...
        category={
          <span>
            ...
            <a
              target="_blank"
              href="https://material-ui-next.com/?ref=loftssh"
            >
              Material UI
            </a>{" "}
            and styled by{" "}
            <a
              target="_blank"
              href="https://lofts.sh/?ref=njsmdp-notifications-page"
            >
              Dean Lofts
            </a>
            . Please checkout the{" "}
                ...
                <GridContainer justify="center">
                  <GridItem xs={12} sm={12} md={3}>
                    ...
                    <Snackbar
                      ...
                      color="info"
                      icon={AddAlert}
                      message="Welcome to Lofts.sh Dashboard based on NextJS and React."
                      open={tl}
                    ...
                    >
                      ...
                      >
                        <Instruction
                          ...
                          text={
                            <span>
                              ...
                              <a href="https://lofts.sh/?ref=njsmdp-notifications-page">
                                Dean Lofts
                              </a>
                        ...
                        <p>
                          ...
                          contact us or send us a tweet @loftssh. We{"'"}
                          re here to help!
                        </p>
                      </DialogContent>
                      <DialogActions
